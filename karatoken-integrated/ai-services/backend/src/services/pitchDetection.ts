...
// ⚡ Bolt Optimization: Precompute static constant values outside frequencyToNote
// to prevent array re-allocations and logarithmic division overhead on every function invocation.
...
export function frequencyToNote(frequency: number): string {
  ...
  // Calculate the number of half steps from A4 using precalculated LOG2_A4
